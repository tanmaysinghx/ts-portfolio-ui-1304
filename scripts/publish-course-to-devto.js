...
function getBanner(section, course_slug, slug) {
  return `https://raw.githubusercontent.com/karanpratapsingh/ts-portfolio-ui-1304/master/public/static/courses/${course_slug}/${section}/${slug}/banner.png`;
}
...
function getBody(course_slug, slug) {
  ...
  body = body.replace(
    /\]\(\/static\/courses/g,
    '](https://raw.githubusercontent.com/karanpratapsingh/ts-portfolio-ui-1304/master/public/static/courses',
  );
